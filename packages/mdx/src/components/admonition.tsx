...
export function Admonition({ variant, title, children }: AdmonitionProps) {
  ...
  return (
    ...
    >
      <div className={cx("mb-2 flex items-center gap-2 text-sm font-semibold", config.titleClass)}>
        <Icon className={cx("size-4 shrink-0", config.iconClass)} aria-hidden="true" />
