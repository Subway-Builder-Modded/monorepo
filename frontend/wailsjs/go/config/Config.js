...
export function ClearCommandLineArgs() {
  return window['go']['config']['Config']['ClearCommandLineArgs']();
}
...
export function GetCommandLineArgs() {
  return window['go']['config']['Config']['GetCommandLineArgs']();
}
...
export function UpdateCommandLineArgs(arg1) {
  return window['go']['config']['Config']['UpdateCommandLineArgs'](arg1);
}
