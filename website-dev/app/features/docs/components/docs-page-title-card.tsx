/** Shared accent-tinted border used on all elevated docs surfaces (sidebar, hero, title card). */
export const DOCS_SURFACE_BORDER_CLASS =
...
export function DocsPageTitleCard({ title, description, icon: Icon }: DocsPageTitleCardProps) {
  return (
    <header className={`mb-4 rounded-2xl ${DOCS_SURFACE_BORDER_CLASS} bg-background/55 p-4 sm:p-5`}>
