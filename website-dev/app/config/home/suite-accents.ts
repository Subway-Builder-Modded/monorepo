import { SITE_SUITES, type SiteSuiteAccent, type SiteSuiteId } from "@/app/config/site-navigation";
...
const HERO_BAR_SUITE_IDS = ["railyard", "registry", "template-mod", "website", "foundry"] as const;
