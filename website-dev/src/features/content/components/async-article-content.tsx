...
type AsyncArticleContentProps = {
  sourcePath: string;
  loadContent: (sourcePath: string) => Promise<React.ComponentType<any> | null>;
...
export function AsyncArticleContent({
  sourcePath,
  loadContent,
  components,
  loadingLines = 2,
}: AsyncArticleContentProps) {
