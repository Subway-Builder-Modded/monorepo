                  ...
                  {categories.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {categories.map((category) => {
                        ...
                        return (
                          <div key={category.id} className="space-y-1.5 px-1">
                            <button
                              type="button"
                                ...
                                {category.tags.map((tag) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={cn(
                                        "group flex w-full items-center justify-between gap-2 rounded-md px-2 py-1.5 text-left text-sm transition-[background-color,color] duration-100 ease-out",
                                        isSelected
                                          ? "bg-background text-[var(--asset-accent-light)] shadow-sm dark:text-[var(--asset-accent-dark)]"
                                          : "text-muted-foreground hover:bg-background/80 hover:text-[var(--asset-accent-light)] dark:hover:text-[var(--asset-accent-dark)]",
                                      )}
