  ...
  return (
    <>
      ...
      <span className="inline-flex items-center gap-2">
        {icon ? <span className={cn("shrink-0", SPOILER_LABEL_CLASS)}>{icon}</span> : null}
...
export function Spoiler({
  ...
  return (
    <details className={cn(SPOILER_DETAILS_CLASS, className)} open={defaultOpen || undefined}>
...
export function MdxDetails({
  ...
  return (
    <details className={cn(SPOILER_DETAILS_CLASS, className)} {...props}>
      {children}
    </details>
  );
}
...
export function MdxSummary({
  ...
  return (
    <summary className={cn(SPOILER_SUMMARY_CLASS, className)} {...props}>
