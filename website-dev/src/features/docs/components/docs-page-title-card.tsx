...
export function DocsPageTitleCard({ title, description, icon: Icon }: DocsPageTitleCardProps) {
  return (
    <header className="mb-4 rounded-2xl border border-[color-mix(in_srgb,var(--suite-accent-light)_25%,transparent)] dark:border-[color-mix(in_srgb,var(--suite-accent-dark)_30%,transparent)] bg-background/55 p-4 sm:p-5">
