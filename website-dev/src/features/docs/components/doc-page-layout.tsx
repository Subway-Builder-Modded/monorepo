    ...
    return (
      <SuiteAccentScope accent={suite.accent}>
        <div className="py-6 lg:py-8">
          <div
            className="grid gap-4 transition-[grid-template-columns] duration-200 ease-in-out motion-reduce:transition-none lg:[grid-template-columns:var(--docs-sidebar-width)_minmax(0,1fr)] xl:[grid-template-columns:var(--docs-sidebar-width)_minmax(0,1fr)_15rem]"
