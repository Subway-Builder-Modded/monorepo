          ...
          <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
            <div>
              <h2 className="text-xl font-bold tracking-tight text-foreground">
                Create A High-Quality Mod Today
              </h2>
              <LightMarkdown className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                The Template Mod makes it easy to get started with mod development, so you can focus
                on building the best mod possible without worrying about setup and configuration.
              </LightMarkdown>
            </div>
