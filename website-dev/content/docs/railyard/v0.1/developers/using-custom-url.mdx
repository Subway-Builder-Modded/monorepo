...
icon: PackagePlus
description: Learn how to host multiple projects in the same repository using a custom Update JSON file.
---
...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.1/github-assets-sha256.png" />
