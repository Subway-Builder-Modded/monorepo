...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.2/github-ratelimit.png" />
...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.2/github-pat.png" />
...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.2/railyard-setup-pat.png" />

</TabItem>
<TabItem value="settings" label="Settings">

To change your token via settings, head to the settings page by clicking on the "Settings" link in the navbar. From there, find the "GitHub Token (Option)" item in the "General Settings" category. Click on "Add" and paste your token into the input field. Click "Save" to update your token.

<Image
  width="1000"
  alt="image"
  src="/images/docs/railyard/v0.2/railyard-settings-generalsettings.png"
/>
...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.2/github-pat-regen.png" />
