...
In order for Railyard to install dependencies, the Mod ID must match a mod in the [registry](https://github.com/Subway-Builder-Modded/registry), and the version constraint must be compatible with at least one version of the mod.
