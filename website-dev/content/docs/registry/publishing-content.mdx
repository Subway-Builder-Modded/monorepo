...
description: Learn how to properly publish your content to the Railyard registry.
icon: CirclePlus
---
...
If you want to host multiple projects within a single repository, follow the [using custom URL guide](/registry/docs/using-custom-url) for further instructions. This will teach you how to set up your custom Update JSON for Railyard to pull from.
...
Railyard requires all map makers to submit the source and quality of their data. This is then used to categorize the data for users looking to download maps. For more detailed information on the specifications of data quality, see [**Data Quality**](/registry/docs/data-quality).
