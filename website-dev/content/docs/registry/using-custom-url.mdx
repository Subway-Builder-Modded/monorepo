...
<Image width="1000" alt="image" src="/images/docs/railyard/v0.2/github-assets-sha256.png" />
...
Now that you have your Update JSON files set up, you can move on to actually [creating the submission ticket on the Railyard registry](/registry/docs/publishing-projects#using-the-issue-template).
