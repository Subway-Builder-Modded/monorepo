...
type AssetManifest struct {
	...
	Deprecation   *Deprecation  `json:"deprecation,omitempty"` // Present iff the asset was deprecated by its author/caretaker — never installable, shown only behind the Deprecated facet
}
