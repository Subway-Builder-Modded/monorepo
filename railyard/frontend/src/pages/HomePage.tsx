  ...
  return (
    <div className="flex flex-col gap-[clamp(1.75rem,3vw,2.5rem)]">
      <PageHeading
        icon={TrainTrack}
        title="Railyard"
        className="mb-6 sm:mb-8 [&>div:last-child>div]:items-center [&>div:last-child>div]:justify-center [&>div:last-child>div>div]:!flex-none [&_h1]:gap-3.5 [&_h1]:text-6xl sm:[&_h1]:text-7xl [&_h1_svg]:size-[1.05em]"
      />
