...
export function AssetDeleted(arg1:types.AssetType,arg2:string):Promise<boolean>;

export function AssetDeprecatedNotDeleted(arg1:types.AssetType,arg2:string):Promise<boolean>;
