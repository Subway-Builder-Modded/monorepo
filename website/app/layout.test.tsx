...
vi.mock('@sbm/website/components/app-shell/navigation/app-navbar', () => ({
  default: () => <nav data-testid="app-navbar">Navbar</nav>,
}));

vi.mock('@sbm/website/components/app-shell/footer/app-footer', () => ({
  default: () => <div data-testid="app-footer">Footer</div>,
}));

vi.mock('@sbm/website/components/ui/footer-bars', () => ({
