...
export function DepotMapForgeHero() {
  ...
  return (
    <section className="relative isolate flex h-[calc(100svh-3rem)] max-h-[calc(100svh-3rem)] items-center overflow-visible border-b border-border/45 bg-background">
      ...
      <div className="relative z-10 grid transform-gpu gap-8 px-5 sm:px-7 md:px-9 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:px-12">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-2.5">
            <Button
              ...
              size="lg"
              className="h-12 px-7 text-sm font-bold tracking-normal transition-none"
            >
              <a
            ...
            <Button
              ...
              size="lg"
              className="h-12 px-6 text-sm font-semibold transition-none"
            >
              <a
