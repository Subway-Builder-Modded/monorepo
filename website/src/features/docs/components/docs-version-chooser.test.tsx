...
import { getVisibleVersions } from "@/config/docs";
import { getVersionSwitchUrl } from "@/features/docs/lib/routing";

vi.mock("@/config/docs", async () => {
  const actual = await vi.importActual<typeof import("@/config/docs")>("@/config/docs");
  return {
    ...actual,
...
vi.mock("@/features/docs/lib/routing", async () => {
  const actual = await vi.importActual<typeof import("@/features/docs/lib/routing")>(
    "@/features/docs/lib/routing",
  );
