...
import { SITE_NAV_ITEMS, getActiveSuite } from "@/config/site-navigation";
import { buildNavbarDisplayModel } from "@/shared/navigation/navbar-model";
import { TOP_BAR_HEIGHT } from "@/hooks/navbar-controller/constants";
import { getTargetPanelMetrics } from "@/hooks/navbar-controller/panel-metrics";
...
import { useNavbarPanelHeight } from "@/hooks/use-navbar-panel-height";
