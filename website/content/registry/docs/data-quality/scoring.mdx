...
### Relationship to the self-reported quality tag {#self-reported-tag}
...
## 6. O/D Shaping {#od-shaping}

_The lightest pillar (weight 0.15) — see [Criterion](#criterion) for why._
...
## 7. Example Countries {#example-countries}
...
## 8. Composite Score {#composite-score}
...
### Worked examples — one per tier {#worked-examples}
...
## 9. Unscored Metrics {#unscored-metrics}
