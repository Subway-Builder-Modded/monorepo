import type { HomeButtonSize } from '@/config/site/homepage.types';
...
export const LANDING_HERO_COPY = {
  railyard: {
    ...
    titleMd: 'Railyard',
    betaBadgeMd: 'Beta',
    descriptionMd: 'All-in-one Map and Mod Manager for Subway Builder.',
...
export function interpolateHeroText(
  template: string,
